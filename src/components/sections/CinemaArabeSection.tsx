import { getCinemaArabeWpPosts, getCinemaWorldWpPosts, getWpPosts, getWpPostsByCategory } from "@/app/api/posts";
...
export default async function CinemaArabeSection() {
  const t = useTranslations("sections.cinemaarabe")
  
  const data = await getCinemaArabeWpPosts();
  return (
    <>
    ...
    >
      <div className="">
           <div className="bg-background z-50 flex justify-between items-center py-3">
